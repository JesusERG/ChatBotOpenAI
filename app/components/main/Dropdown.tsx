  ...
  return (
    <>
      {isOpen ? (
        ...
        <div
          className="w-10 h-10 p-3 rounded-xl animate-fadeInUp bg-primary absolute left-10 top-8 items-center justify-center shadow-md cursor-pointer shadow-highlight"
